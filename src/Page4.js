...
<div class="flex flex-wrap justify-left mt-14" >
        ...
        <img src="./assets/assets/Images/dig.png" class="relative left-60" style={{width:"150px", height:"70px" }} /> 
        </div>
       <div class="ml-96 left-60 mb-24 relative bottom-10">
       <img src="./assets/assets/Images/user.png" class="ml-56" />
       ...
       <h1 class="text-slate-500 relative right-44 mt-46">Browse programs</h1>
        ...
        <div>
       <img src="./assets/assets/Images/Courses.png" class="ml-64 mb-36" style={{height:"300px",width:"700px"}}/>
       </div>
       </div>
            </div>
    )
