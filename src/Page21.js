    ...
    return (
        <div>
            ...
            <img src="./assets/assets/Images/dig.png" class="mt-6 ml-32"></img>
                ...
                <img src="./assets/assets/Images/bell.png" style={{marginLeft:1050,height:50,width:60}} class="relative bottom-16"></img>
            ...
            <div style={{width:200,height:250}} class="border-2 bg-white float-left text-gray-500 border-gray-300 rounded-xl drop-shadow-2xl ml-20 relative bottom-10">
                ...
                <img src="./assets/assets/Images/layer2.png" class="mt-32 relative right-4"></img>
            ...
            <div style={{width:700,height:350}} class="border-2 bg-white float-left border-gray-300 rounded-xl drop-shadow-2xl ml-32 relative bottom-10">
                <img src="./assets/assets/Images/aws.jpg" class="w-36 ml-20 mt-10"></img>
                ...
                <img src="./assets/assets/Images/python.jpg" class="w-36 ml-20 mt-10"></img>
