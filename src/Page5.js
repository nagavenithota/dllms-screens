...
function Page5() {
    return (
        <div>
            <div>
        <div class="
        min-h-screen  relative bottom-30 w-30 p-4 border-4">
        <div class="ml-80 relative left-60">
        <img src="./assets/assets/Images/dig.png" style={{width:"150px", height:"70px"}} class="relative right-56"/>
        <h1 class="text-bold ml-52 relative left-1 -mt-10 text-base underline  "> My class room</h1>
        <img src=" ./assets/assets/Images/bellicon.png" class="relative left-96 -ml-14 -mt-6"/>
        <img src="./assets/assets/Images/user.png" class="relative left-96 -mt-9"/> 
        <div class="box-border h-32 w-3/4  border-4 relative right-52 mr-96">
        <img src="./assets/assets/Images/aws.jpg" style={{width:"200px", height:"120px"}} />
        ...
        <div class="box-border h-32 w-3/4  border-4 relative right-52 mr-96">
        <img src="./assets/assets/Images/python.jpg" style={{width:"200px", height:"120px"}} />
