...
function Page12() {
    return (
        <div class='border-gray-500 border bg-white ml-56 mt-96'style={{width:800,height:500,backgroundColor:"#EBF3FE"}}>
            <img src="./assets/assets/Images/dig.png" class="ml-56 "/>
            <img src="./assets/assets/Images/Layer 2.png" class="ml-56 "style={{width:150,height:100}}/>
            <img src="./assets/assets/Images/tickmark.png" class="ml-96 mb-96"style={{width:30,height:30,position:"relative",bottom:100}}/>
            ...
            <img src="./assets/assets/Images/aws.jpg"style={{height:100,width:150}}/>   
