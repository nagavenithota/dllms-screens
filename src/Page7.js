...
const Page7 = () => {
    return (
        ...
        <div>
        <div class="w-max">
        <img src="./assets/assets/Images/dig.png" class="mt-6 ml-32"></img>
            <h1 style={{marginLeft:900}} class="relative bottom-8"><u>My Class Room</u></h1>
            <img src="./assets/assets/Images/bellicon.png" style={{marginLeft:1050}} class="relative bottom-16"></img>
            <img src="./assets/assets/Images/user.png" style={{marginLeft:1120}} class="relative bottom-24 w-8"></img> 
        </div>
        ...
        <div>
           ...
           <img src="./assets/assets/Images/video.png"></img>
           </div>
           ...
           <div>
               <img src="./assets/assets/Images/user.png" class="ml-20"></img>
               ...
               <img src="./assets/assets/Images/user.png" class="ml-40"></img>
               ...
               <img src="./assets/assets/Images/user.png" class="ml-40 relative top-2"></img>
               ...
               <img src="./assets/assets/Images/greendot.png" class="w-6 h-6 relative bottom-28" style={{marginLeft:800}}></img>
