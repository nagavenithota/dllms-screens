        ...
        <div>
            ...
            <div>
               ...
               <div>
                   ...
                   <img class="ml-96 relative left-80 bottom-10" src="./assets/assets/Images/download.png"></img>
               ...
               <button class="text-white text-xs w-52 p-4 rounded-tr-3xl bg-yellow-500 ml-32 rounded-l-3xl relative bottom-14 left-32" style={{marginLeft:904}}>Have a doubt?Rise a query</button>
                   <img src="./assets/assets/Images/greendot.png" class="w-2 relative bottom-20 left-32" style={{marginLeft:900}}></img>
        </div>
    )
}